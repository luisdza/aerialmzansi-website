...
# Image list
imgs <- dplyr::tibble(image_name = AzureStor::list_blobs(cont, info="name"))

imgs$link <- paste0('https://aerialmzansi.blob.core.windows.net/images/', imgs$image_name)

imgs |>
  dplyr::mutate(link = paste0('https://aerialmzansi.blob.core.windows.net/images/', image_name)) |>
  dplyr::mutate(image_name = kableExtra::cell_spec(image_name, "html", link))
