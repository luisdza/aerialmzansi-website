...
while(!test_result){
  ...
  test_result <- sf::st_is_valid(test)
}
...
# Image list
blob_image_names <- AzureStor::list_blobs(cont, info="name")

imgs <- paste0("![](",blob_endp_url, "images/", blob_image_names , "){group=\"group1\" description=\"",blob_image_names,"\"}")

knitr::kable(imgs, col.names = "")
```
:::
